...
<div class="panel">
    <div class="panel-heading">
        ...
        <small>Supplier {{ $supplier->user->name }}</small>
        <div class="right">
            <button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
            <a supplier="{{ $supplier->id }}" class="cetak"><i class="lnr lnr-printer"></i></a>
        </div>
    </div>
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Filter Transaksi Gagal</h3>
        <small>Supplier {{ $supplier->user->name }}</small>
        <div class="right">
            <button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
            <a supplier="{{ $supplier->user->name }}" class="cetak"><i class="lnr lnr-printer"></i></a>
        </div>
    </div>
    <div class="panel-body no-padding">
        <table class="table table-striped">
...
<script>
    $('.cetak').click(function(){
        ...
        window.location = "/pemilik/laporan/filter/"+supplier;
    })
</script>
@endsection
