			...
			<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 95%;"><div class="sidebar-scroll" style="overflow: hidden; width: auto; height: 95%;">
				<nav>
					<ul class="nav">
                        ...
                        <li><a href="{{ route('admin.produk.index') }}" class=""><i class="lnr lnr-dice"></i> <span>Produk</span></a></li>
                        ...
                        <li><a href="{{ route('pembelian.pesanan.index') }}" class=""><i class="lnr lnr-cart"></i> <span>Order</span></a></li>
                        @endif
					</ul>
				</nav>
